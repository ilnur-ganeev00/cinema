...
<head>
    ...
    <meta content="width" name="MobileOptimazed">
...
<body>
    ...
    <header class="block-01">
        <div class="block-01-container container">
            <div class="logo-and-nav">
                <div class="logo">
                    <a class="logo__ref" href="https://university.innopolis.ru" target="_blank">
                        <img class="logo__image" src="images/logo.png" alt="Логотип Университета Иннополис">
                    </a>
                </div>
                <div class="navigation-wrap">
                    <div id="burgerButton" class="navigation-burger">
                        <span></span>
                    </div>
                    <nav id="burger" class="navigation burgerNav">
                        <button id="closeBurger">X</button>

                        <ul class="navigation__list">
                            <li class="navigation__item">
                                <a class="navigation__ref"
                                    aria-label="Наш сайт специально создан для удобного заказа билетов в кино"
                                    href="#buy_ticket">Заказать билет</a>
                            </li>
                            <li class="navigation__item">
                                <a class="navigation__ref" aria-label="Основные преимущества нашего кинотеатра"
                                    href="#anchorAdvantages">Преимущества</a>
                            </li>
                            <li class="navigation__item">
                                <a class="navigation__ref" aria-label="Список фильмов, которые можно посмотреть"
                                    href="#movies">Фильмы</a>
                            </li>
                            <li class="navigation__item">
                                <a class="navigation__ref" aria-label="Список наших контактов в социальных сетях"
                ...
                <div class="city-location">
                    <span>Ваш город:</span>
                    <span id="city_name" class="city-location__name">Не определен</span>
                </div>
            </div>
            <div class="topic">
                <h1 class="topic__subtitle1-1" id="buy_ticket">
                    Закажите билет в кино
                </h1>
                <h2 class="topic__subtitle2-1">
    ...
    <section class="block-02">
        <div class="block-02-container container">
            <div class="welcome">
                <h2 class="welcome__subtitle2-2">
                    Добро пожаловать!
                </h2>
                <p class="welcome__sub">Cumque dolorem eum harum laudantium libero molestias saepe soluta? Facere minima
                    optio perferendis
                    quibusdam
            ...
            <section>
                <h2 class="advantages-subtitle" id="anchorAdvantages">
                    Почему мы?
                </h2>

                <div class="advantages">
                    <div class="advantages-col advantages-col1">
                        <div class="advantages-image-wrap">
                            <img class="advantages-image-wrap__img" src="images/b2_icon_1.jpg"
                                alt="У нас большие экраны, включая формат аймакс">
                        </div>
                        <div>
                            <h3 class="advantages-col1__subtitle3-2">
                                Большие экраны
                            </h3>
                            <p class="advantages__sub">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. At autem cum dolores dolorum
                                eius error expedita illum itaque molestiae mollitia nemo, nostrum officia quas ratione
                                tempora temporibus veritatis vero voluptates.
                            </p>
                        </div>
                    </div>
                    <div class="advantages-col2">
                        <div class="advantages-image-wrap2">
                            <img class="advantages-image-wrap__img2" src="images/b2_icon_2.jpg"
                                alt="У нас объемный звук">
                        </div>
                        <h3 class="advantages-col2__subtitle3-2">
                            Объемный звук
                        </h3>
                        <p class="advantages__sub">
                    ...
                    <div class="advantages-col3">
                        <div class="advantages-image-wrap3">
                            <img class="advantages-image-wrap__img3" src="images/b2_icon_3.jpg"
                                alt="У нас удобные кресла">
                        </div>
                        <h3 class="advantages-col3__subtitle3-2">
                            Удобные кресла
                        </h3>
                        <p class="advantages__sub">
    ...
    <section class="block-03">
        <div class="block-03-container container">
            <div class="movie-list">
                <h2 id="movies" class="movie-list__header">
                    Выберите фильм
                </h2>
                <div class="movie-list__table-wrap">
                    <table class="movie-list__table">
                        <thead>
                            <tr>
                                <th class="movie-list__first-col">
                                    <a href="#">
                                        Начало сеанса
                                    </a>
                                    <span id="triangle-up"></span>
                                </th>
                                <th class="movie-list__second-col">
                                    <a href="#">
                                        Название фильма
                                    </a>
                                    <span id="triangle-down"></span>
                                </th>
                                <th class="movie-list__third-col">
                                    <a href="#">
                                        Жанр
                                    </a>
                                </th>
                                <th class="movie-list__fourth-col">Цена от
                                </th>
                            </tr>
                        </thead>
                        <tbody id="filmsHire" class="movie-list__tbody">
                            <!-- <tr class="movie-list__tline_light">
                                <td id="startFilm_1" class="movie-list__first-col">
                                </td>
                                <td class="movie-list__second-col">
                                    <a id="nameFilm_1" href="https://www.kinopoisk.ru/film/1008445/" title="Человек-паук: Вдали от дома"
                                        target="_blank">
                                    </a>
                                </td>
                                <td id="genreFilm_1" class="movie-list__third-col">
                                </td>
                            ...
                            <tr>
                                <td id="startFilm_2" class="movie-list__first-col">
                                </td>
                                <td class="movie-list__second-col">
                                    <a id="nameFilm_2" href="https://www.kinopoisk.ru/film/1122114/" title="Собачья жизнь 2"
                                        target="_blank">
                                    </a>
                                </td>
                                <td id="genreFilm_2" class="movie-list__third-col">
                                </td>
                                <td class="movie-list__fourth-col">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="33px" height="33px">
                            ...
                            <tr class="movie-list__tline_light">
                                <td id="startFilm_3" class="movie-list__first-col">
                                </td>
                                <td class="movie-list__second-col">
                                    <a id="nameFilm_3" href="https://www.kinopoisk.ru/film/846824/" title="История игрушек 4"
                                        target="_blank">
                                    </a>
                                </td>
                                <td id="genreFilm_3" class="movie-list__third-col">
                                </td>
                                <td class="movie-list__fourth-col">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="33px" height="33px">
                            ...
                            <tr>
                                <td id="startFilm_4" class="movie-list__first-col">
                                </td>
                                <td class="movie-list__second-col">
                                    <a id="nameFilm_4" href="https://www.kinopoisk.ru/film/693730/" title="Люди в черном: Интернэшнл"
                                        target="_blank">
                                    </a>
                                </td>
                                <td id="genreFilm_4" class="movie-list__third-col">
                                </td>
                                <td class="movie-list__fourth-col">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="33px" height="33px">
            ...
            <div>
                <p class="block-03__sub">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid eum facere obcaecati quam rem
                    repellendus veritatis. Aliquam beatae, delectus dignissimos enim exercitationem mollitia nisi
                    pariatur quaerat quam, qui quibusdam sunt!
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="block-04">
        <div class="block-04-container container">
            <div class="block-04-wrap">
                <img class="block-04-wrap__image" src="images/gift.png" alt="Подарок каждому зрителю">
            </div>
            <div>
                <h2 class="block-04__subtitle2-3">
                    Подарок каждому!
                </h2>
                <p class="block-04__info">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aperiam
                ...
                <p class="block-04__info block-04__last">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab
                    aperiam
                    aspernatur, cum, cupiditate
                    excepturi expedita libero mollitia nesciunt nihil nobis obcaecati quasi ratione reprehenderit sequi
                    sint, tenetur unde velit veniam!</p>
                <div class="block-04__get-gift">
                    <span id="giftButton" class="block-04__link">Получить подарок</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="block-05">
        <div class="block-05-container container">
            <div class="block-05-text">
                <h2 class="block-05__subtitle2-5">
                    Фильмы
                </h2>
            ...
            <div class="movie-grid-container">
                <div class="movie-grid owl-carousel">
                    <div class="block-05__item">
                        <div class="block-05__inner1">
                            <div>
                                <img class="block-05__poster" src="images/Spider-man.jpg" alt="Человек-паук" title="Человек-паук">
                            </div>
                            <div class="block-05__description">
                                <p class="block-05__text1">Человек-паук</p>
                                <hr class="block-05__hr" />
                                <p class="block-05__text2">Lorem ipsum dolor sit amet, consectetur</p>
                                <div class="block-05__links">
                                    <a class="block-05__link1" href="https://www.facebook.com" target="_blank">
                                    ...
                                    <a class="block-05__link1" href="https://twitter.com" target="_blank">
                                        <svg class="block-05__svg" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="34px" height="34px">
                                            <defs>
                                                <filter filterUnits="userSpaceOnUse" id="Filter_0" x="0px" y="0px"
                                    ...
                                    <a class="block-05__link1" href="https://www.behance.net" target="_blank">
                                        <svg class="block-05__svg" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <a class="block-05__link1" href="https://dribbble.com" target="_blank">
                                        <svg class="block-05__svg" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="34px" height="34px">
                                            <defs>
                                                <filter filterUnits="userSpaceOnUse" id="Filter_0" x="0px" y="0px"
                    ...
                    <div class="block-05__item">
                        <div class="block-05__inner1">
                            <div>
                                <img class="block-05__poster" src="images/Dog.jpg" alt="Собачья жизнь 2" title="Собачья жизнь 2">
                            </div>
                            <div class="block-05__description">
                                <p class="block-05__text1">Собачья жизнь 2</p>
                                <hr class="block-05__hr" />
                                <p class="block-05__text2">Lorem ipsum dolor sit amet, consectetur</p>
                                <div class="block-05__links">
                                    <a class="block-05__link1" href="https://www.facebook.com" target="_blank">
                    ...
                    <div class="block-05__item">
                        <div class="block-05__inner1">
                            <div>
                                <img  class="block-05__poster" src="images/ManInBlack.jpg" alt="Люди в черном: Интернэшнл"
                                    title="Люди в черном: Интернэшнл">
                            </div>
                            <div class="block-05__description">
                                <p class="block-05__text1">Люди в черном: Интернэшнл</p>
                                <hr class="block-05__hr" />
                                <p class="block-05__text2">Lorem ipsum dolor sit amet, consectetur</p>
                                <div class="block-05__links">
                                    <a class="block-05__link1" href="https://www.facebook.com" target="_blank">
    ...
    <section class="block-06">
        <div class="block-06-container container">
            Map
        </div>
    </section>

    <footer class="block-07" id="contacts">
        <div class="block-07-container container">
            <!-- <div class="block-07-contacts">
                <a class="block-07__link1" href="https://www.facebook.com" target="_blank">

                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="48px"
                        height="48px">
                        <defs>
                            <filter filterUnits="userSpaceOnUse" id="Filter_0" x="0px" y="0px" width="48px"
                                height="48px">
                                <feOffset in="SourceAlpha" dx="0" dy="1" />
                                <feGaussianBlur result="blurOut" stdDeviation="1" />
                                <feFlood flood-color="rgb(0, 0, 0)" result="floodOut" />
    ...
    <form id="getPresent" class="user-form" action="serv.php" method="POST" enctype="multipart/form-data">

        <div class="modal">

            <button id="closeGetPresent">X</button>
            ...
            <div class="modal__form">
                ...
                <select class="present-form" name="place" required>
                    ...
                    <option value="place 2">Выбор2</option>
                    <option value="place 3">Выбор3</option>
                    <option value="place 4">Выбор4</option>
                    <option value="place 5">Выбор5</option>
                    <option value="place 6">Выбор6</option>
                    <option value="place 7">Выбор7</option>
                    <option value="place 8">Выбор8</option>
                    <option value="place 9">Выбор9</option>
                    <option value="place 10">Выбор10</option>
                </select>

                <input id="first" type="radio" value="1" name="some" />
                <label for="first">Выбор 1</label>
                <input id="second" type="radio" value="2" name="some" />
                <label for="second">Выбор 2</label>

                <textarea class="present-form" placeholder="Комментарий" name="textarea"></textarea>

                <input type="hidden" name="agreed" value="no" />
                <input id="agree" type="checkbox" name="agreed" value="yes" required />
                <label for="agree">Я согласен на обработку персональных данных</label>

                <button id="sendPresentInfo" type="submit">Заказать</button>

                <input class="present-form" id="upload-some" type="file" name="file" />
                <label for="upload-some">Прикрепить файл</label>
            </div>
        </div>
    </form>
        ...
        <div class="modal">
            ...
            <div class="modal__form">
                ...
                <div>
                    ...
                    <input class="film-form" id="orderSeatNumber" type="text" />
                </div>
                <div>
                    <span>Стоимость билета:</span>
                    <input class="film-form" id="orderFilmPrice" type="text" />
                </div>
                <!-- <div>    
                    <span>Количество билетов:</span>
                    <input class="film-form" value="1" min="1" type="number" id="orderFilmCountTicket" />
                </div> -->
                <!-- <div>
                ...
                <div>
                    ...
                    <input class="film-form" type="tel" id="orderFilmPhone" />
                </div>
                <div>
                    <span>Имя:</span>
                    <input class="film-form" type="text" id="orderClinetName" />
                </div>

                <div class="input-wrap">
                    <button id="sendOrder" class="button1">Забронировать</button>
                </div>
            </div>
    ...
    <div id="choose_city">
        <div class="modal">
            <button id="closeChoose_city">X</button>

            <div class="modal__form">
                <div>
                    <span>Ваш город</span>
                    <input name="choose_city__form" class="choose_city__form" type="text"
